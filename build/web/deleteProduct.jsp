    ...
    if (idParameterStr != null && !idParameterStr.isEmpty()) {
        try {
            ...
            try {
                ...
                deleteStatement = con.prepareStatement("DELETE FROM products WHERE id = ?");
                deleteStatement.setInt(1, idParameter);
                int rowsAffected = deleteStatement.executeUpdate();

                if (rowsAffected > 0) {
                    response.sendRedirect("viewProduct.jsp"); // Redirect to a different page after successful deletion
                } else {
